...
const loginForm = ({
    ...
    return (<form className="" onSubmit={(e) => login(e)}>
        ...
        <div className="mb-3">
            ...
            <input type="password" className="form-control" id="js_connexion_password" value={password} onChange={(e) => handleChangePassword(e)}  autoComplete="true" current-password="true" />
        </div>
