		...
		<>
			...
			<main className='container'>
				<div className='container-fluid'>
					...
					<h6 className="text-center">En vigueur au 01/08/2022</h6>
					<p>
						...
						l""Utilisateur", du site awsd.fr , ci-après le "Site", les présentes mentions légales.
					</p>
					<p>
					...
					<p>
						L’édition et la direction de la publication du Site est assurée par Jean-Vivien Sicot, domiciliée 1 Av. Pierre
						Proudhon, dont le numéro de téléphone est 33762971167, et l'adresse e-mail jeanvivien.sicot@lapiscine.pro.
						ci-après l'"Editeur".
					</p>
					<h4>
					...
					<p>
						L'hébergeur du Site est la société o2switch, dont le siège social est situé au 222-224 Boulevard Gustave
						Flaubert 63000 Clermont-Ferrand , avec le numéro de téléphone : 0444446040 + adresse mail de contact
					</p>
					<h4>
