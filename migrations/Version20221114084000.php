 ...
 */
final class Version20221114084000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD external_link TINYINT(1) NOT NULL, CHANGE updated updated DATETIME on update CURRENT_TIMESTAMP');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project DROP external_link, CHANGE updated updated DATETIME DEFAULT NULL');
