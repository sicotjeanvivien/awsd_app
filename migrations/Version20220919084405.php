 ...
 */
final class Version20220919084405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE organisator_task CHANGE making making TINYINT(1) DEFAULT 0 NOT NULL, CHANGE updated updated DATETIME on update CURRENT_TIMESTAMP');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE organisator_task CHANGE making making TINYINT(1) NOT NULL, CHANGE updated updated DATETIME DEFAULT NULL');
