 ...
 */
final class Version20221017075612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE games_chuck_norris_fact (id INT AUTO_INCREMENT NOT NULL, fact LONGTEXT NOT NULL, liked INT DEFAULT 0, disliked INT DEFAULT 0, is_valided TINYINT(1) DEFAULT 0, created DATETIME NOT NULL, updated DATETIME on update CURRENT_TIMESTAMP, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE games_chuck_norris_fact');
